...
const Home = () => {
  return (
    <div name="home" className="h-screen w-full bg-bgColor mt-5">
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full mx-auto max-w-screen-md mb-8 md:mb-0 md:mr-8">
          <img src={laptop} alt="hand_wave" className="rounded-2xl w-20 h-20 gap-5 mr-5 inline-flex-row" />
        ...
        <div className="ml-0 md:ml-20 mb-8 md:mb-0">
          <img src={heroImage} alt="my profile" className="rounded-full w-40 h-40 md:w-80 md:h-80 object-cover ml-auto max-w-md" />
        </div>
      </div>
    </div>
  );
